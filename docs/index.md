...
layout: home
title: Astral.js
description: A lightweight UI toolkit for building modern user interfaces
---

# ![Astral Icon](/assets/images/astral-icon.png) Astral.js
...
- [Core Concepts](/core-concepts/event-driven)
